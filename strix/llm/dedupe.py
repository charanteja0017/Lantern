...
def check_duplicate(
    ...
    try:
        ...
        # Route dedupe through the "dedupe" role so operators can steer it
        # to a small, cheap classifier without polluting the reasoning budget.
        from strix.llm.router import get_router

        completion_kwargs = get_router().prepare_completion_args("dedupe", completion_kwargs)
