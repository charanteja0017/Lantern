...
async def run_cli(args: Any) -> None:
    ...
    def signal_handler(_signum: int, _frame: Any) -> None:
        # Match cleanup_on_exit: tear down the sandbox container too, not just
        # the tracer. Without this the dashboard's Stop button (SIGTERM) leaks
        # the 4GB sandbox; over time those zombies starve future runs of RAM.
        from strix.runtime import cleanup_runtime
