...
APP=strix
REPO="usestrix/strix"
# Default sandbox image. This should match the image used by the web stack
# (deploy/docker-compose.yml) unless overridden by the user.
STRIX_IMAGE="${STRIX_IMAGE:-ghcr.io/maramharsha/novahunter-sandbox:latest}"
