...
- [`.github/workflows/ci.yml`](https://github.com/MaramHarsha/NovaHunter/blob/main/.github/workflows/ci.yml)
  — lint, type-check, tests, compose-file validation, and
  `setup.sh --dry-run`. Runs on every push and PR.
- [`.github/workflows/release.yml`](https://github.com/MaramHarsha/NovaHunter/blob/main/.github/workflows/release.yml)
